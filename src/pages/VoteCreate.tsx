...
import { setNewVote, createVote } from "../Redux/VoteReducer";
        ...
        setVoteAnswerState({
            ...
            questions: voteAnswerState.questions.map((question, qIdx) => {
                if (questionIndex == qIdx) {
                    question.elements = question.elements.map(
                        (element, index) => {
                ...
                {voteAnswerState.questions.map((question, QuestionIndex) => (
                    <div key={QuestionIndex}>
                        <TextField
                            ...
                            variant="outlined"
                            onChange={(event) =>
                                handleQuestionTitle(event, QuestionIndex)
                            }
                        />
